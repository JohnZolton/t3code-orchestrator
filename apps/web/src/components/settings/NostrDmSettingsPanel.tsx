...
export function NostrDmSettingsPanel() {
  ...
  const handleAdd = useCallback(async () => {
    ...
    try {
      ...
      await api.nostrDm.addAllowedPubkey({
        pubkey: trimmed,
  ...
  const handleRemove = useCallback(
    async (pubkeyHex: string) => {
      ...
      try {
        const api = ensureEnvironmentApi(environmentId);
        await api.nostrDm.removeAllowedPubkey({ pubkeyHex });
        void loadPubkeys();
      } catch (e) {
        ...
        <section className="overflow-hidden rounded-lg border border-border bg-card">
          ...
          <div className="px-5 py-4">
            <p className="mb-4 text-xs text-muted-foreground">
              Only these Nostr pubkeys can DM your thread npubs.
            </p>
            ...
            {loading ? (
              ...
              <div className="rounded-md border border-dashed border-border p-6 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Add your Nostr pubkey above to enable DMs.
                </p>
              </div>
            ) : (
