...
describe("orchestration projector", () => {
  ...
  it("keeps an interrupted turn stopped when a stale running session update arrives", async () => {
    const createdAt = "2026-02-23T08:00:00.000Z";
    const startedAt = "2026-02-23T08:00:05.000Z";
    const interruptedAt = "2026-02-23T08:00:06.000Z";
    const staleRunningAt = "2026-02-23T08:00:07.000Z";
    const model = createEmptyReadModel(createdAt);
