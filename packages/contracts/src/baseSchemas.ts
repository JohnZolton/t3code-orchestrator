...
export const OrchestratorRunId = makeEntityId("OrchestratorRunId");
export type OrchestratorRunId = typeof OrchestratorRunId.Type;
export const OrchestratorLaneId = makeEntityId("OrchestratorLaneId");
export type OrchestratorLaneId = typeof OrchestratorLaneId.Type;
export const OrchestratorArtifactId = makeEntityId("OrchestratorArtifactId");
export type OrchestratorArtifactId = typeof OrchestratorArtifactId.Type;
export const OrchestratorApprovalId = makeEntityId("OrchestratorApprovalId");
export type OrchestratorApprovalId = typeof OrchestratorApprovalId.Type;
export const ProcessRuleVersionId = makeEntityId("ProcessRuleVersionId");
export type ProcessRuleVersionId = typeof ProcessRuleVersionId.Type;
